...
As a freelancer, I work on daily basis with [The Guild](https://the-guild.dev). Most of our projects are built with GraphQL. Throughout the 3 years of adopting it, our team **tested practices and developed open source tools that helped to improve our workflow**.
...
If you want to read more about the GraphQL ecosystem and keep up with everything that happens around it, I would recommend also checking out [The Guild’s Blog](https://the-guild.dev/blog).
