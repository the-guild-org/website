...
This is needed in order to improve performance of Apollo store. [You can read more about this here](https://apollographql.com/docs/react/data/fragments/#fragments-on-unions-and-interfaces).
