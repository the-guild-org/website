...
But, this can be tedious to implement and using a package like [**graphql-scalars**](https://www.graphql-scalars.dev) can actually help since it comes inbuilt with some of the commonly used scalars which you can import and use.
