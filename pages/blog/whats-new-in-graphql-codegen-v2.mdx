...
[GraphQL Code Generator](https://github.com/dotansimha/graphql-code-generator/) is here for ~5 years, and it's improving developer exprience for many developers (>3M downloads a month on NPM!). We have constantly listening and gradually improving Codegen throughout all these years, and it's time for a big release!
