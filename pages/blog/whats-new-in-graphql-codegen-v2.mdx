...
Some time ago we started advocating the [`near-operation-file`](https://www.graphql-code-generator.com/docs/presets/near-operation-file) preset, for generating GraphQL client code next to the `.graphql` operation file.
