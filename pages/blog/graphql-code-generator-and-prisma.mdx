...
If you're creating a GraphQL server you'd probably want to have a database behind it with somthing like [Prisma](https://www.prisma.io/).
...
The [GraphQL Code-Generator](https://graphql-code-generator.com/) is an easy way to create type saftey with your GraphQL project.
