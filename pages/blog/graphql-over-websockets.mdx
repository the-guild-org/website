...
export const meta = {
  ...
  image: '/blog-assets/graphql-over-websockets/graphql-websockets.png',
};
...
> A couple of years ago, while I was still workin at Apollo, [Lee Byron](https://github.com/leebyron), [Rob Zhu](https://github.com/robzhu), [Dotan simha](https://github.com/dotansimha) and [I](https://github.com/urigo) we worked on the GraphQL Subscriptions spec and the reference implementation.
