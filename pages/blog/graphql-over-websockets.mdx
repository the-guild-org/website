...
> A couple of years ago, while I was still workin at Apollo, together with [Lee Byron](https://github.com/leebyron), [Rob Zhu](https://github.com/robzhu) and [Dotan simha](https://github.com/dotansimha), we worked on the GraphQL Subscriptions spec and the reference implementation.
