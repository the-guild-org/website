...
It's based on [`graphql-java`](https://graphql-java.com) and compatible with its implementation for [`DataFetcher`s](https://www.graphql-java.com/documentation/v13/data-fetching/).
