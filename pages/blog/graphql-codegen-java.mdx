...
export const meta = {
  ...
  author: 'dotan',
  tags: ['graphql', 'codegen', 'apollo-android', 'apollo', 'android', 'java'],
  date: '2019-06-19',
...
As you probably already know, [GraphQL Code Generator](https://graphql-code-generator.com/) has become the most popular GraphQL code generation tool in the community.
...
A [Apollo-Android generator](https://github.com/dotansimha/graphql-code-generator/pull/1924) and a [Java backend](https://graphql-code-generator.com/docs/plugins/java-resolvers) resolvers signature generator.
...
The usage of the generated code is the same you had before, just follow [the instructions of Apollo-Android runtime](https://github.com/apollographql/apollo-android#consuming-code).
...
It’s based on [`graphql-java`](https://www.graphql-java.com/) and compatible with it’s implementation for [`DataFetcher`s](https://www.graphql-java.com/documentation/v13/data-fetching/).
