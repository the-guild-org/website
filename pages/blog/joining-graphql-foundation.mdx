...
export const meta = {
  ...
  thumbnail:
    '/blog-assets/joining-graphql-foundation/graphql-foundation-logo.png'
}
...
[Dipesh Wagle](https://github.com/Dipeshwagle) lead and [@ardatan](https://github.com/ardatan) joined him and both have did some awesome work!
Check out their PRs on the website, follow the discussions, let us know for any feedback or improvements you have
