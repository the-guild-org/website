...
export const meta = {
  title:
    'Getting the best out of your existing GraphQL client by using Relay patterns with GraphQL Code Generator',
  author: 'laurin',
...
![Fragmentized Component Tree](/blog-assets/getting-the-best-out-of-your-graphql-client-by-using-relay-patterns-through-graphql-code-generator.mdx/component-tree-diagram.png)
...
Fortunately, we are happy to announce that we now have a preset for bringing the above Relay patterns to your existing projects, no matter what client library you are currently using, without having to switch over and commit to the Relay eco-system.
