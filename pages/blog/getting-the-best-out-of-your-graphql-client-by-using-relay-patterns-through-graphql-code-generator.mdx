...
Fortunately, we are happy to announce that we now have an opinionated preset for bringing the above Relay patterns to your existing projects, no matter what client library you are currently using, without having to switch over and commit to the Relay eco-system.
