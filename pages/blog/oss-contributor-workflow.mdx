...
- We released [The Guild's contributor guide](https://github.com/the-guild-org/Stack/blob/master/CONTRIBUTING.md)
...
- [The Guild's tooling](https://github.com/the-guild-org/Stack/blob/master/CONTRIBUTING.md#the-tooling) for maintaining open source libraries
- A [new system](https://github.com/the-guild-org/shared-resources/) for managing our repositories (Process based labeling system, issue templates)

Open source has revolutionized the way we build, collaborate and release software and there are definitely a lot of instances where the community of contributors and maintainers have taken the lead to make the projects thrive in the ecosystem and this is really exciting to see.
Making open source more approachable is beneficial for the maintainers, users and the contributors themselves thereby opening new paths for them that seemed harder before. And our strong belief is that contributing to open source shouldn't be hard!
...
"We see that as [The Guild's core mission!](https://the-guild.dev/about-us)"
...
To give you an insight, these are some of the projects which we currently manage as individual contributors:

- [GraphQL Codegenerator](https://www.graphql-code-generator.com/)
- [GraphQL Mesh](https://www.graphql-mesh.com/)
- [GraphQL Tools](https://www.graphql-tools.com/)
- [GraphQL Modules](https://graphql-modules.com/)
- [Apollo Angular](https://apollo-angular.com/)
- [GraphQL CLI](https://graphql-cli.com/introduction)
- [GraphQL Config](https://graphql-config.com/introduction)
- [SOFA](https://www.sofa-api.com/)
...
As you can see, the list goes on (for a good reason), and we have more interesting projects on the way which you can find [here](https://the-guild.dev/open-source) 😉

And some of the major things which we were looking to do were to:

- Provide a great experience for beginners who want to contribute to any of these projects
...
This is when we strongly felt the need to sync/orchestrate labels across all the repositories while also respecting the differences between the projects (one size may not fit all). This led us to a proof of concept with different label syncing tools and after quite a bit of analysis, we landed on [Label Syncer](https://github.com/micnncim/action-label-syncer) to manage both master and repository level declarative labels (If someone from Github is reading this, maybe this should be an inbuilt feature 😇)

Doing this was pretty simple. You can find the repo [here](https://github.com/the-guild-org/shared-resources/) which is used as the master repository to push all the labels downstream and we still retain the repo specific labels in their own repository ([like this](https://github.com/Urigo/graphql-mesh/blob/master/.github/labels.yml))
...
Now, [Urigo](https://twitter.com/UriGoldshtein) had an interesting thought process - since we had already published the [contributor workflow guide](https://github.com/the-guild-org/Stack/blob/master/CONTRIBUTING.md#a-typical-contributor-workflow), why not we label issues keeping the same in mind? All we needed to do was push an issue towards progress from Step 1 to Step N

The goal here was to make it more obvious for anyone who arrives to an issue where exactly it stands and most importantly, what can you do to help advance the solution.
...
The next thing we did was to prepare a set of [standard issue templates](https://github.com/Urigo/graphql-mesh/tree/master/.github/ISSUE_TEMPLATE) which remains almost the same across all our repositories. Again, a work in progress we will tweak this as the need arises. This gives us an ability to suggest a standard template to file issues and PRs to all the new contributors asking for all the important details like the environment and version they use, possible reproductions/screenshots, additional context and also providing them with checklists to be actioned upon when filing an issue.

While all this might seem very simple, doing this has a long term benefit of communicating your expectations as a maintainer to the community when they are looking to contribute. Now, this is something which some of the projects tend to ignore.
