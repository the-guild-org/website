...
export const meta = {
  ...
  date: "2019-10-25",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*3ow-Coz2GhxfmNY447Wacw.gif?raw=true",
};
...
-   [Prisma recently transferred the project](https://www.prisma.io/blog/the-guild-takes-over-oss-libraries-vvluy2i4uevs) to [The Guild](http://the-guild.dev) — and we **completely rewrote it** and addressed **more than ⅔ of the issues** (and the remaining are waiting for feedback)
