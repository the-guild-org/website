...
**Tools used:** [Angular-cesium](http://www.angular-cesium.com/), [Apollo Angular](https://github.com/kamilkisiela/apollo-angular), [CesiumJS](https://cesiumjs.org/), [Angular](https://angular.io/)
...
![](/blog-assets/graphql-geo-strike/gameplay.webm)
...
![](/blog-assets/graphql-geo-strike/map.webm)
...
`angular-apollo` exposes the state as an Rx Observable which allowed us to plug that stream to our amazing angular-cesium framework and have the players magically move and update on a 3d scene rendered with CesiumJS!
...
This game is the product of a collaboration between [Webiks](http://webiks.com/), a software development company that specialize in high-end data analysis and real time situational awareness web based applications. And [The Guild](https://the-guild.dev), a group of freelance developers, open source contributors and the creators of [angular-cesium](http://www.angular-cesium.com/).
