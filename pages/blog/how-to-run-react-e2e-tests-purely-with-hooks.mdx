...
export const meta = {
  ...
  date: "2020-2-10",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*aB7wj3tpGEKr47XjlNKijg.png?raw=true",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*aB7wj3tpGEKr47XjlNKijg.png?raw=true "Photo by Alex Kondratiev on Unsplash")
