...
export const meta = {
  ...
  date: "2018-9-7",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/0*U_GfqaDPrEX8cD7x.jpg?raw=true",
};
...
Now let’s think of what React components should exist in our application besides the main pages. Once we identify them we should select their corresponding element in the Webflow project and set a new attribute; the key’s gonna be `af-el` (Appfairy element) and the value should be set to the name of the component e.g. `consult-form`:
...
-   The full app’s source code can be [found here](https://github.com/DAB0mB/Appfairy/tree/master/examples/prefetch).
