...
The integration of GraphQL and TypeScript with client-side application has evolved in the recent times:

### 2016: Manual Typings

We started with writing down manually TypeScript types for our operations. It worked, but it didn't scale. It needed maintenance to make sure it's following the exact selection set we are fetching.
