...
export const meta = {
  ...
  authors: ['arda'],
  date: '2022-07-21',
  description: 'The new way of building servers in JavaScript',
...
- Help other frameworks in the ecosystem to migrate to this new library and standard
