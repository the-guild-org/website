...
export const meta = {
  ...
  image:
    'https://user-images.githubusercontent.com/20847995/112631973-ebfede80-8e0d-11eb-9be2-c788a0f7085d.png',
};
...
[We’ve](http://the-guild.dev) recently [taken over the maintenance](/blog/taking-over-merge-graphql-schemas) of [GraphQL-Scalars](https://www.graphql-scalars.dev) library from the amazing team of OK-Grow!

Since then we completely rewrote the library using TypeScript, upgraded all dependencies, closed all the issues and PRs and increased the number of scalars in the package with new scalars like: `BigInt(Long)` , `GUID` , `HexColorCode` , `Hexadecimal` , `IPv4` , `IPv6` , `ISBN` , `MAC` , `JSON` and more. You can see all scalars in the [**README**](https://www.graphql-scalars.dev/docs/introduction).
