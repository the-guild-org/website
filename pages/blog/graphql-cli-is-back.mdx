...
export const meta = {
  ...
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*_7z5TiN1g22xJpdOQbfZ1Q.gif?raw=true",
};
...
- [Prisma recently transferred the project to The Guild](https://www.prisma.io/blog/the-guild-takes-over-oss-libraries-vvluy2i4uevs) — and we **completely rewrote** it and closed over 100 issues
...
- Rich ecosystem and compatibility with libraries, editors and IDEs based on a unified [graphql-config](https://medium.com/the-guild/graphql-config-708dd0e5d15f)
