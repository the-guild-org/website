...
export const meta = {
  ...
  image:
    '/blog-assets/graphql-error-handling-with-fp/graphql-error-1012x400.png',
  thumbnail:
    '/blog-assets/graphql-error-handling-with-fp/graphql-error-1012x400.png'
}
...
For a more detailed explanation, you can read this article from Sasha Solomon: [200 OK! Error Handling in GraphQL](https://sachee.medium.com/200-ok-error-handling-in-graphql-7ec869aec9bc), or watch this video from [@notrab](https://github.com/notrab):
