...
GraphQL has support for Union types (only for Types, not yet for Inputs). We can take advantage of it and design our schema to specify all possible results: expected and unexpected / error cases.
