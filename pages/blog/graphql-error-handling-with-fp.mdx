...
export const meta = {
  ...
  image:
    '/blog-assets/graphql-error-handling-with-fp/graphql-error-1024x512.png',
  thumbnail:
    '/blog-assets/graphql-error-handling-with-fp/graphql-error-1024x512.png'
}
...
If you use [Envelop](https://www.envelop.dev/) or [GraphQL Yoga](https://www.graphql-yoga.com/) (both developed by [The Guild](https://the-guild.dev/)), you can already benefit from it today by using this [Envelop plugin](https://www.envelop.dev/plugins/use-extended-validation#schema-directive-flow))
:::
...
[GraphQL Code Generator](https://www.graphql-code-generator.com/) is a tool developed by [The Guild](https://the-guild.dev/) which generates type definitions which corresponds to the GraphQL schema. It has several plugins and we'll use 3 of those:
...
For such cases, the upcoming Ecma TC39 proposal for [Error Cause](https://github.com/tc39/proposal-error-cause) is useful as it allows to chain errors. Polyfills exist: [Pony Cause](https://github.com/voxpelli/pony-cause) or [error-cause](https://www.npmjs.com/package/error-cause).
:::
