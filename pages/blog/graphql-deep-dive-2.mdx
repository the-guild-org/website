...
export const meta = {
  title: 'GraphQL - Usecase and Architecture',
  author: 'tvvignesh',
...
If you are in the Kubernetes world, you also have a lot of ingress controllers like [**Nginx Ingress**](https://kubernetes.github.io/ingress-nginx/), [**Ambassador**](https://www.getambassador.io/), [**Kong**](https://konghq.com/), [**Contour**](https://projectcontour.io/) and so on which can help.
...
- How do I do asynchronous communication? Do I use event queues like [**Kafka**](https://kafka.apache.org/), [**RabbitMQ**](https://www.rabbitmq.com/) or [**NATS**](https://nats.io/) ?
...
And you can even put a GraphQL layer or ORM on top of all of them if you want and take the complexity away from the services (eg. with [**Prisma 2**](https://www.prisma.io/) or [**GraphQL Mesh**](https://graphql-mesh.com/)).
...
- I try to refer case studies and see how others are already solving the same problem and this can help me save a lot of my time. Avoiding to re-invent the wheel. For GraphQL, you may find them [**here**](https://www.graphql.com/case-studies/)
...
While most of the things in this blog may not be related to GraphQL itself, these are some things which you need to keep in mind before starting your journey with GraphQL. In the next blog, I will show you how my GraphQL Tech Stack looks like as I use it to build [Timecampus](https://www.twitter.com/timecampus) and we will dive deeper into each layer of the stack, one piece at a time.
