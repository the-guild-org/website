...
export const meta = {
  title: 'Improve your Apollo-Client v3 type-safety with GraphQL Codegen',
  author: 'dotan',
  tags: ['graphql', 'codegen', 'typescript', 'react', 'angular', 'apollo'],
  date: '2020-10-26',
  description: 'Get the most out of your type-system using GraphQL Codegen',
  image: '/blog-assets/graphql-code-generator/cover.png',
};

export default withArticle({ ...meta });

We've recently introduced improvements for GraphQL-Codegen that can quickly improve your workflow and type-safety with Apollo-Client v3.

I'll try to cover the popular codegen plugins you can use, that already works with Apollo-Client v3.

# possibleTypes

If you are already familiar with GraphQL-Codegen and the plugins it offers, you probably know `fragment-matcher` plugin.
...
If you are an [advanced configuration for your Apollo-Client cache](https://www.apollographql.com/docs/react/caching/cache-configuration/#data-normalization), you can customize the behaviour of your cache.
...
Apollo-Client also supports `TypedDocumentNode` now (since `v3.2`, [you can read more about it here](https://the-guild.dev/blog/typed-document-node)).
...
You can also generated `apollo-angular` types, Vue-Apollo, Stencil-Apollo and much more with GraphQL-Codegen.

[You can find a list of all available plugins here](https://graphql-code-generator.com/docs/plugins/index), and [here you can find a list of tips for intergrating codegen with your frontend applications](http://localhost:3000/blog/graphql-codegen-best-practices).
