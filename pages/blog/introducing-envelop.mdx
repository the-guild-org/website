...
- [`useOperationFieldPermissions`](https://www.envelop.dev/plugins/use-operation-field-permissions) - a plugin that allows you to check if the fields queried in an operation are allowed for a user before execution starts.
