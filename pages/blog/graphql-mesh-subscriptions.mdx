...
export const meta = {
  title: 'Consume Webhooks as GraphQL Subscriptions using GraphQL Mesh',
  author: 'arda',
...
GraphQL Mesh let’s you query any data source and protocol with GraphQL by using powerful handlers (Swagger/OpenAPI, gRPC, SOAP and others..)
...
> We already are able to consume our existing REST APIs in GraphQL Mesh even if they don't have any schema by using our JSON Schema Handler. [See more](https://the-guild.dev/blog/migrating-from-rest)
