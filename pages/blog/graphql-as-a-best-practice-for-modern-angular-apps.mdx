...
export const meta = {
  ...
  date: "2016-7-28",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*yTMBzO8zfEhKr4Lky6pjZQ.png?raw=true",
};
      
export default withPost({ ...meta });
  

## **_Angular, meet GraphQL_**
...
Some of the current best practices include composing everything into [Components](https://docs.angularjs.org/guide/component), using one-way data binding, lazy loading, having an immutable global state management (Redux & ng-rx), and more…
...
![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*d7JZJH23iJZONJV536q2iQ.png?raw=true "The Discourse REST API — look on the links at the bottom on the GraphQL version of this")
