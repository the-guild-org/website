...
Like every open source project we maintain, we always use it ourselves in production - in our own products and with our clients.
In [Hive, our open source GraphQL Schema Registry](https://the-guild.dev/graphql/hive) we also use this new plugin and [on this PR](https://github.com/kamilkisiela/graphql-hive/pull/2063) you can see the changes we've made to introduce it and the benefits we got from it.
Feel free to explore [Hive's source code](https://github.com/kamilkisiela/graphql-hive) to find how [The Guild is using GraphQL](https://www.youtube.com/watch?v=78ufgsWfgVc&list=PLhCf3AUOg4PgQoY_A6xWDQ70yaNtPYtZd&index=3&t=1081)
