...
lot of documents (query, mutation, and fragments) in your project.

<Callout>
  For more information/ a history of this functionality, you can read more about it in the former
  [`gql-tag-operations-preset`](https://the-guild.dev/graphql/codegen/plugins/presets/gql-tag-operations-preset)
  that is now replaced by the `client-preset`. This idea was originally explored by [Maël
