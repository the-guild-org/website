...
The schema policies feature is powered by [GraphQL-ESLint](https://the-guild.dev/graphql/eslint), which is another project built and
maintained by The Guild. We are using a subset of this feature, specifically designed for linting
GraphQL schemas.
