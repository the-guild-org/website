...
image: /blog-assets/graphql-hive/hive-introducing-schema-policy/cover.png
thumbnail: /blog-assets/graphql-hive/hive-introducing-schema-policy/cover.png
---
...
![GraphQL-ESLint](/static/shared-logos/products/eslint.svg)
...
You can use Policy today with your existing [GraphQL-Hive](https://app.graphql-hive.com/) projects. [Documentation is also available](https://the-guild.dev/graphql/hive/docs/features/schema-policy).

After enabling Policy and rules for your organization or project, try [performing a GraphQL schema `check`](https://the-guild.dev/graphql/hive/docs/features/schema-registry#check-a-schema) to execute the policy check.