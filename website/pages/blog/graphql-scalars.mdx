...
[`graphql-scalars`](http://npmjs.com/package/graphql-scalars) name on npm, to
[Saeris](https://github.com/Saeris) for letting us take other scalar implementations from his
fork, [stems](https://github.com/stems) for their
