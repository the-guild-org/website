...
<Video
  src="/blog-assets/nextra-2/nextra-2-flexsearch.mov"
  className="rounded-3xl border border-gray-700"
/>
...
and improvement of this library. In the end, we migrated all of our documentation websites, and
received a bunch of positive feedback from our community ❤️.
