---
title: Announcing Nextra 2 Framework
tags: [nextra, next.js]
...
and React, uses Tailwind CSS and [other amazing open-source libraries](https://nextra.site/about#credits).
...
and will inform screen readers about opening a link in a new tab.
...
You can extend Nextra with any of `rehype`/`remark` plugins, just pass them to the `nextra` function.
...
`nextra-theme-docs` was completely redesigned to be more flexible and configurable for all of your needs.
...
Out of the box, `nextra-theme-docs` has Next SEO installed. By default, in the front matter you can set `title`,
`description`, `canonical` and `openGraph` and they will be passed directly to the `<NextSeo />` component.
...
[The Guild](/) discovered Nextra 2 from the first betas and actively participated in the development and improvement of this library.
In the end, we migrated all of our documentation websites, and received a bunch of positive feedback
