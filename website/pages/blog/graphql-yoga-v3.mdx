...
[created a library that lets you create cross-platform HTTP servers](https://the-guild.dev/blog/fetch-for-servers)
...
In
[Yoga v2 we added support for `@defer` and `@stream`](https://the-guild.dev/blog/announcing-graphql-yoga-v2#graphql-features-from-the-future)
...
We have
[migration guide](https://the-guild.dev/graphql/yoga-server/v3/migration/migration-from-yoga-v2)
try it out! We can't wait answer your
