...
[Couchbase](http://couchbase.com), [MongoDB](https://mongodb.com) and [Node.js](https://nodejs.org).
...
Speaking of practice, let's move on to the next step where we going to implement our first add-on for
...
[Boost](http://boost.org), [OpenCV](http://opencv.org), [CGAL](http://cgal.org) and many more.
