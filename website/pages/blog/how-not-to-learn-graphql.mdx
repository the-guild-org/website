...
"_GraphQL is a front-end technology_", "_Federation is the only solution for unified graph and,
services orchestration_", "_GraphQL is a replacement of REST"_ are common misconceptions that are
most likely linked to biased learning of GraphQL.
...
[howtographql.com](http://howtographql.com), where you'll be able to test multiple frameworks and
