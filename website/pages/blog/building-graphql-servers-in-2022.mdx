...
date: 2022-06-28
description: In this talk we'll learn about the tools needed to build your own GraphQL server from scratch using GraphQL Yoga.
...
[GraphQL Yoga](https://graphql-yoga.com) takes a different approach by providing enough bells and whistles that make you production-ready, but builds itself on top of the core primitives of HTTP. Yoga is runtime agnostic too, so if you're currently working with Cloudflare Workers, Vercel Functions, AWS Lambda or something else, Yoga will fit right in.
...
<Video src="https://youtube.com/embed/XnmB1-2i8mI" title="Build a Modern GraphQL Server using GraphQL Yoga and the Modern JS Ecosystem Tools" />
...
<Video src="https://youtube.com/embed/zS-1SizRPnU" title="Building GraphQL Servers in 2022 - Overview of the Best New Tools You Should Add to Your Toolbelt" />
