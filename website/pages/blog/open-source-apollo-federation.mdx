...
We recognized the importance of the already existing ecosystem of tools and existing knowledge base.
That is why `@theguild/federation-composition` library shares the same API, produces the exact same
