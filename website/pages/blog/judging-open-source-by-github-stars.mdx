...
So, that's scary. The premium stars scored decently as `B`, but the cheap ones resulted in the lowest score — `E`.  Who knows, maybe there's an ultra-premium stars service that's scoring an `A`?
