...
description:
  ...
  show how you can use these patterns in your existing project, no matter what client library you
  are currently using.
...
overloading and [`TypedDocumentNode`](https://the-guild.dev/blog/typed-document-node)) for inferring
the correct GraphQL operation and variables type.
