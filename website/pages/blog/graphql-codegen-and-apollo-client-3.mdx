...
Apollo-Client also supports `TypedDocumentNode` now natively (since `v3.2`, [you can read more about it here](/blog/typed-document-node)).
...
[You can find a list of all available plugins here](https://graphql-code-generator.com/docs/plugins/index), and [here you can find a list of tips for integrating codegen with your frontend applications](/blog/graphql-codegen-best-practices).
