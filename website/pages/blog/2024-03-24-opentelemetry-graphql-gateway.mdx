...
### New cross-runtime configuration helper
...
openTelemetrySetup({
   contextManager: new AsyncLocalStorageManager(),
   traces: {
...
<video>
   ...
   <a alt="Click on this image to download video demo" href="/blog-assets/opentelemetry-graphql/demo-span-parenting.mp4">
