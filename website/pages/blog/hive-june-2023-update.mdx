...
date: 2023-07-18
description:
  Learn what is new on GraphQL Hive. Learn what is new on GraphQL Hive. Learn what is new on GraphQL
  Hive.
image: /blog-assets/x
...
After shipping [Schema Policy](/blog/hive-introducing-schema-policy.mdx) last month we are happy to
...
For Federation projects we now show the subgraph information on the Explorer page. It is now easier
to understand whcih types and fields are referenced from which subgraphs, which helps you doing
strategic decissions.

![Subgraph Information on Explorer](/blog-assets/hive-june-2023-update/subgraph.png)

## Filter GraphQL Operations by Client

It is now possible to filter the GraphQL operations by client on the Operations view. This allows
you to quickly find all operations that are used by a specific client.

![Filter Operations by Client](/blog-assets/hive-june-2023-update/filter-by-client.png)

## Improved Documentation Search

We improved the search on the documentation page for your convencience. It might seem like a small
change but it makes a big difference.

![New documentation search](/blog-assets/hive-june-2023-update/docs-search.png)

## What Do You Think Is Still Missing?

The development of Hive is driven by community member needs and contributions. We appreciate any
