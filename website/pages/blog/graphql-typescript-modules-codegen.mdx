...
GraphQL Code Generator can take a JS/TS export from GraphQL-Modules to generate server-side typings (or anything else that its [plugins can generate](https://graphql-code-generator.com/plugins)). So, let's export typeDefs without any business logic that includes resolvers, DI, providers etc…
...
You can check our working example that is created by using this approach; [https://github.com/darkbasic/graphql-modules-seed](https://github.com/darkbasic/graphql-modules-seed)
