...
<Callout type="info">
  ...
  Currently, there's no official package for this ( *yet*! ). However, there's an [issue on the GraphQL Scalars repo](https://github.com/Urigo/graphql-scalars/issues/1996).
