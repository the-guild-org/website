...
There are many ways to query a GraphQL server from a TypeScript project. Your choice can depend on
your Framework or your preference of GraphQL client library.
...
In this article, we will learn how to use the GraphQL Code Generator client preset with vanilla
