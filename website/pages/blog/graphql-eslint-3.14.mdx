...
import graphqlJsSuggestions from 'public/blog-assets/graphql-eslint-3.14/graphql-js-suggestions.gif'

## Introduction

Hi! I am Dimitri 👋, the current maintainer of the
[GraphQL-ESLint](https://github.com/B2o5T/graphql-eslint) linter, and today I want to share with you
...
[most of the examples](https://github.com/B2o5T/graphql-eslint/tree/master/examples) were updated to
...
<Comparison>
```graphql filename="❌ Incorrect" copy=false
input Input @oneOf {
  foo: String!
  bar: [Int!]!
}
```
```graphql filename="✅ Correct" copy=false
input Input @oneOf {
  foo: String
  bar: [Int!]
}
...
[Hive](https://the-guild.dev/graphql/hive), we prefix all files with executable definitions with
