...
date: 2020-05-02
description: Use different variants of GraphQL schema.  Live and running GraphQL API as the source of truth of a schema.
...
Follow the [_"Using Environments"_](https://graphql-inspector.com/docs/recipes/environments) chapter in our docs.
...
This approach is very useful when you don't deploy an API on every Push and your default branch is fine with temporary breaking changes. To learn more, read [_"Using Endpoints"_ chapter](https://graphql-inspector.com/docs/recipes/endpoints).
