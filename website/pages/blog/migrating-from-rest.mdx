...
description:
  ...
  do it automatically, without writing code and even if you don't have any schema for your existing
  REST API sources.
...
[You can check the announcement blog post to learn more](https://the-guild.dev/blog/graphql-mesh)
