...
date: 2021-12-19
description: Flexible modern way of adding an authorization layer on top of your existing GraphQL backend systems.
...
})((context, fieldArgs, post, parent) => post.status === 'public' || post.author.id === context.user?.id)
```
...
- If all of your authorization logic doesn't depend on the data and shouldn't perform complex calculations, you can use [operation-field-permissions](https://envelop.dev/plugins/use-operation-field-permissions) [Envelop](https://envelop.dev) plugin.
