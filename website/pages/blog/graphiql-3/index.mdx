...
libraries Radix and Headless UI and to make another major release with `monaco-editor` bumped as
GraphiQL 4.
...
<Callout type="info">
  **Note:** I call it `no real progress` because `graphql-prototype` was prototype written from
  scratch that doesn't integrate into current GraphiQL monorepo
</Callout>
