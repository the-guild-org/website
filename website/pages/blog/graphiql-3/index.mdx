...
authors: dimitri
date: 2023-07-09
description: GraphiQL 3 was released, here is what was changed and what's will be in GraphiQL 4.
...
10 month ago
[GraphiQL 2 was released](https://github.com/graphql/graphiql/releases/tag/graphiql%402.0.0) with
...
Unfortunately previously planned in [roadmap](https://github.com/graphql/graphiql/issues/2328) most
waited features as integration [monaco-editor](https://github.com/microsoft/monaco-editor) and new
docs explorer (aka Query Builder) were not introduced.

After months and months no progress were made, and I was called to join forces and help community.

<Callout type="info">
  **About me:** I am Dimitri POSTOLOV, software engineer from The Guild. You may know me as
  maintainer of [GraphQL-ESLint](https://the-guild.dev/graphql/eslint/docs) and
  [Nextra](https://nextra.site).
</Callout>

## How I Started Maintain Library
...
>![Comment of my proposal of improving ESLint config](./img.png)</Anchor>

export const Warning = () => (
  <span style={{ fontFamily: '"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' }}>⚠️</span>
)
...
longer maintained and still doesn't have official support of React 18. So community started to
...
When I come to a new project I always start by reading the codebase, try to reproduce active issues
and fixes them, note some things that I can improve in project in general. Below are list of various
improvements that were made by me:

1. Update Cypress to v12 from v4 [#2893](https://github.com/graphql/graphiql/pull/2893).
...
1. Update all examples to use React 18 [#3185](https://github.com/graphql/graphiql/pull/3185).

1. Exclude `"dependencies"` from bundle for `@graphiql/react`, `@graphiql/plugin-explorer` and
...
1. Remove unnecessary `<div />` wrappers [#3235](https://github.com/graphql/graphiql/pull/3235).

1. Simplify Next.js and Vite examples with `monaco-graphql`
...
maintain this monorepo, but to achieve it, stable release should be released first ☝️.

So I decided to propose release GraphiQL 3 without Reach UI and replace him by maintained libraries
Radix and Headless UI and to make another major release with `monaco-editor` bumped as GraphiQL 4.
...
With all above changes I also included tab reorder feature:

![Reorder tabs feature](./reorder-tabs.gif)

{/* prettier-ignore */}
<p className="mt-3 text-center italic">Tab reorder made by
  [@mylesmmurphy](https://github.com/mylesmmurphy)
  [#3111](https://github.com/graphql/graphiql/pull/3111)</p>

Try GraphiQL 3 by installing with your favorite package manager:
...
14 month ago initial issue was created on integration `monaco-editor` in GraphiQL.
...
but no one real progress in GraphiQL was made:
...
I already started on such as difficult integration, my initial PR
[#3234](https://github.com/graphql/graphiql/pull/3234) or you can try it in following
[preview url](https://deploy-preview-3234--graphiql-test.netlify.app) (alpha version will be
available soon too).
...
I hope you learned of current state of GraphiQL and what is coming. Follow me on
