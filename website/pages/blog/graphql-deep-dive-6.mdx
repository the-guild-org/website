...
[Prisma](http://prisma.io), [Knex](http://knexjs.org) or [Sequelize](https://sequelize.org), or even
an underlying resource like a REST API maybe with something like
[GraphQL Mesh](https://graphql-mesh.com) or Graph databases like [Dgraph](https://dgraph.io)) and
...
For eg. you might push your schema to a registry if you use something like federation for all the
...
things which I do repeatedly as part of my workflow.
...
time and also providing a high degree of reliability and confidence to what you ship to production.
