...
Ever since [The Guild has taken over GraphQL Tools](https://the-guild.dev/blog/graphql-tools-v6), we
kept our promise and like every open source library we maintain,
[we keep improving and supporting](https://the-guild.dev/blog/tag/graphql-tools) it on a daily
basis.
