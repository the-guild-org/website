...
<Callout>
  ...
  ones](https://github.com/vercel/next.js/tree/canary/packages/next/src/pages) 🤓.
</Callout>
...
> Once [`rehype-pretty-code`](https://github.com/atomiks/rehype-pretty-code){' '}
> [officially migrates to `shikiji`](https://github.com/atomiks/rehype-pretty-code/issues/107), I'll
> add support for changing default themes too!
