...
In our case, we will use [GraphQL Yoga](https://the-guild.dev/graphql/yoga-server) because it
support GraphQL and also uses the same powerful
[@whatwg-node library](https://github.com/ardatan/whatwg-node) as
[feTS](https://the-guild.dev/openapi/fets/server/quick-start), to support
