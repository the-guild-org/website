...
Spread the word about Nextra on [𝕏](https://x.com) using the `#Nextra` hashtag. You can also follow
me on [𝕏](https://x.com/dimaMachina_) and [GitHub](https://github.com/dimaMachina) to stay updated!
