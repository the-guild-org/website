...
First Markdown heading `<h1>` will set `<title>` and `<meta property="og:title">` and front matter
`description` will set `<meta name="description">` and `<meta property="og:description">` in
`<head>` element.
