...
<Callout type="info">
  See [Nextra
  website](https://github.com/shuding/nextra/tree/d5cb1bc0e84494cbcc8decbae56fb091ce9999f0/docs) or
  Nextra's [blog
  example](https://github.com/shuding/nextra/tree/d5cb1bc0e84494cbcc8decbae56fb091ce9999f0/examples/blog)
  as an examples of this mode.
</Callout>
...
<Callout type="info">
  `pnpm@9` by default [run `pre`/`post`
  scripts](https://pnpm.io/9.x/cli/run#enable-pre-post-scripts).
</Callout>
...
<Callout type="info">
  Read more about server components i18n in [Next.js
  docs](https://nextjs.org/docs/app/building-your-application/routing/internationalization).
  <br />
  See [working example of i18n
  website](https://github.com/shuding/nextra/tree/d5cb1bc0e84494cbcc8decbae56fb091ce9999f0/examples/swr-site)
