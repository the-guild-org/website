...
Below structure is named
[folders with index pages](https://nextra.site/docs/docs-theme/page-configuration#folders-with-index-page)
in Nextra 3. You can see that there is a folder `docs` and `docs.mdx` in the same level.
...
Above structure can't be implemented with [page file convention](#page-file-convention), to fix it
in Nextra 4 there is a new front matter option called `asIndexPage`. You should set
`asIndexPage: true` in front matter of `docs/page.mdx`
...
With [content directory convention](#content-directory-convention) set `asIndexPage: true` in front
matter of `docs/index.mdx`
