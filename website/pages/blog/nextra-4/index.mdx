...
<h5>Create directory with `content` name</h5>

Put `content` directory in root of your project, or in `src` directory.
...
Theme Docs has been updated to [TailwindCSS 4](https://tailwindcss.com/docs/v4-beta). The previously
used [TailwindCSS prefix](https://tailwindcss.com/docs/configuration#prefix) `_` which helped
prevent class name conflicts, has been replaced with `x:`. If you have overridden Nextra's theme
classes, make sure to update them accordingly.
