...
description:
  ...
  React Compiler, GitHub Alert Syntax, _meta.global file
date: 2025-01-10
authors: [dimitri]
image: https://nextra.site/og?title=Nextra%204%0AApp%20Router%20/%20Turbopack
tags: [react, nextra, nextjs, app-router, turbopack, pagefind, rsc, i18n, react-compiler]
---
...
It's now possible do define your pages in single `_meta` file, suffixed with `.global`. All API is
same as per folder `_meta` files, with 1 exception: folder items should have `items` field.

##### Example

For the following structure you may have following `_meta` files:
