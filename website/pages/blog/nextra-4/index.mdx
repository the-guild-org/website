...
Nextra 4 exclusively uses Next.js [App Router](https://nextjs.org/docs/app). Support for the [Pages Router](https://nextjs.org/docs/pages) has been discontinued.
...
[Next.js App Router convention](https://nextjs.org/docs/getting-started/project-structure#app-routing-conventions) with ✨ enhanced page extensions `page.{md,mdx}`.
...
After being one of our [most requested features](https://github.com/shuding/nextra/issues/1054) for over 2 years, Nextra 4 finally supports [Turbopack](https://nextjs.org/docs/architecture/turbopack), the Rust-based incremental bundler. Enable it by adding `--turbopack` to your dev command:
...
function. You cannot pass custom `remarkPlugins`, `rehypePlugins` or `recmaPlugins` since they are functions.
