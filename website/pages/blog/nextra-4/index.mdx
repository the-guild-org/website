...
All fields from front matter are exported as `metadata` object in MDX files. If you don't want to
use front matter you can export `metadata` from your MDX file, but you can't use both - front matter
and export of `metadata` from MDX file.
