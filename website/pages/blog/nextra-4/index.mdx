...
[Refreshing the Next.js App Router When Your Markdown Content Changes](https://steveruiz.me/posts/nextjs-refresh-content) rely on extra dependencies like `concurrently` and `ws`. These approaches include 
...
Checkout Nextra's [docs website](https://github.com/shuding/nextra/tree/d5cb1bc0e84494cbcc8decbae56fb091ce9999f0/examples/docs) and [i18n website example](https://github.com/shuding/nextra/tree/d5cb1bc0e84494cbcc8decbae56fb091ce9999f0/examples/swr-site).
...
Configuration for remote docs was changed, please refers to
...
also you will need to manually modify `pageMap` list in `layout` file, to properly display sidebar
...
## Conclusion. Why Prefer **Nextra 4** over Other MDX Libraries?
...
Spread the word about Nextra on [X](https://x.com) using the `#Nextra` hashtag. You can also follow
me on [X](https://x.com/dimaMachina_) and [GitHub](https://github.com/dimaMachina) to stay updated!
