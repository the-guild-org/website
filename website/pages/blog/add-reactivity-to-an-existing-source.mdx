...
<Video src="/blog-assets/add-reactivity-to-an-existing-source/PimpMyGraphQL.webm" title="Pimp my graphQL" />
...
<Callout>Special thanks to [n1ru4l](https://twitter.com/n1rual) who helped me find the nicest way to do it ;)</Callout>
