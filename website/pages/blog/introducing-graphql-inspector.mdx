...
Throughout almost three years of working with GraphQL, me and [The Guild](/)
introduced solutions that changed the way we write our projects today.
...
In [The Guild](/), we love open-source, our whole careers were possible because
of that. We also found out each other through Open-Source :)
