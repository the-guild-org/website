...
Ever since [The Guild took over GraphQL Tools](/blog/graphql-tools-v6), we've
been getting feedback from companies using a variety of industry tools and have been working to
transform Schema Stitching into the best GraphQL gateway solution for their needs. Today we are
happy to announce GraphQL Tools v7, which brings Schema Stitching to a whole new level thanks to
