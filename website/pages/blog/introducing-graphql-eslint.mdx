...
- [`graphql-eslint` in GitHub](https://github.com/B2o5T/graphql-eslint)
- [List of available rules](https://github.com/B2o5T/graphql-eslint/blob/master/docs/README.md) (and
  [planned rules](https://github.com/B2o5T/graphql-eslint/issues?q=is%3Aissue+is%3Aopen+label%3Anew-rule))
...
[how it works, please refer to the docs' directory in the repo](https://github.com/B2o5T/graphql-eslint/blob/master/docs/README.md).

## Writing Your Own Rules

Since it's running as a real ESLint parser,
[you can easily customize it and write your own rules](https://github.com/B2o5T/graphql-eslint/blob/master/docs/custom-rules.md),
...
[Create a PR!](https://github.com/B2o5T/graphql-eslint#contributing)
