...
<Video src="https://youtube.com/embed/dpw9EHDh2bM" title="React Today and Tomorrow and 90% Cleaner React With Hooks" />
...
export function useUserListQuery(baseOptions?: QueryHookOptions<UserListQueryVariables>) {
  return useApolloQuery<UserListQueryQuery, UserListQueryVariables>(UserListQueryDocument, baseOptions)
}
```
