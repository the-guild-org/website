...
> Thanks to Taz Singh for the image, check out his
...
Its hard to summarize everything that happened, but the main messages we got from the conferences
were:
...
other tool in the ecosystem**, including our competitors - **the opposite of a vendor lock-in**.
