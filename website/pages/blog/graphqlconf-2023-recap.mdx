...
authors: [laurin, urigo]
tags: [graphql]
date: 2023-09-25
description: Explore the highlights of GraphQLConf 2023. Learn about the latest trends in GraphQL, from gateway
...
Postman, The Graph, solo.io, Inigo, Stellate, StepZen(IBM), Neo4J, WunderGraph, HyGraph,
Graphabase), we had the incredible opportunity to immerse ourselves in the world of GraphQL. The
breath of quality talks by speakers from companies like Netflix, Intuit, Meta, AWS, Coinbase,
Salesforce, Atlassian, Apollo, Meetup, IBM, Booking.com, Wix.com, Okta, Miro and others showed there
was such a big need for an open conference. A few of the participates said it was one of their
favorite confs ever (it certainly was for us!) The Linux Foundation events team, lead by Emily Ruf
and the GraphQL Foundation Conference committee, lead by Keith Babo, had made a remarkable job with
the first ever GraphQL open conference!
...
community. Lee continuously working hard, leading the GraphQL community since the beginning of
GraphQL to this day, from working groups, board meetings, to the first open GraphQL Conf! We are
lucky to have such a leader to our community! It was truly inspiring to see the faces of the people
we had only known through outdated avatars on GitHub or Twitter, who are the driving force behind
the vibrant GraphQL community.
...
3. That innovation leads to multiple great open source solutions at any layer of the stack - choice
   for developers - separate the concerns between gateway, subgraph and schema registry - no need
   for vendor lock-in, choose the best tool for each layer
...
> There are too many great talks to cover, but you can find the recordings of all the workshops and
> talks [on the website's schedule (click on each talk)](https://graphql.org/conf/schedule/)

The first day of the conference was workshops day, with many great workshops across everything
GraphQL. You can find all the workshops and their recording in the schedule
[here](https://graphql.org/conf/schedule/)

The second day started with welcoming remarks by Lee, followed by great keynotes by Marc-Andre,
...
focused on highlighting the biggest open source innovations from the last year, the ones that were
being announced at the conference and how we all can and should use them to improve our GraphQL
developer experience. This talk also acted as a guide to some of the talks at the conference. He
covered important releases for GraphQL Clients and GraphQL Gateways. One of the key takeaways was
the emergence of GraphQL gateways as a common pattern.
...
available choices and alternatives out there and also talked about how should you go about choosing
...
the Foundation, for remote execution and federation of services that challenges the existing
patterns of specification-less Apollo Federation with a fresh approach.
...
SOAP, gRPC, etc...). On the other hand,Federation requires a specific subgraph structure.
Additionally, it was interesting to learn that even Facebook, with its vast resources, finds value
in a monolithic approach for their GraphQL implementation.
...
ideas to explore and improve the GraphQL community as a whole. And if we look very far aheads to the
future,
...
gave us a glimpse at what would be possible in the near future!
...
also invite you to join the discussions on the official [GraphQL discord](discord.graphql.org),
where the vibrant community continues to thrive. Also, new community Meetup groups have been
announced at the conference, so make sure to
...
connect with the GraphQL community. Let us know how can we make GraphQL Conf 2024 even better!

**See you next year!**

### The Guild's Recommended Stack

Many conference participants asked us about our choice of a GraphQL Gateway, server and schema
registry. We are always trying to be as unbiased as possible, highlighting all the possible choices
and making sure everyone knows that **our individual tools work separately and integrate with any
other tool in the ecosystem**, including our competitors - **the opposite of a vendor lock-in**, so
you can choose the best tool that works for you. But, if we need to provide a simple answer, without
looking at your particular use case, our choice of tools and architecture is:
