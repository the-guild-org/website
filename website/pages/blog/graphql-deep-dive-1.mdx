...
Today, the GraphQL spec and its implementations have been donated by Facebook to the GraphQL
...
other organizational members as well.
...
tools like [**this**](https://graphql.org/code) and
...
[graphql-helix](https://github.com/contrawork/graphql-helix) and more. And if you are using other
...
- Are you dependent on [Apollo](https://apollographql.com) or its ecosystem like federation? Go for
  apollo-server
...
And infact, if you are keen on understanding how every graphql-server performs, I would recommend
...
[**GraphQL Codegen**](https://graphql-code-generator.com) which we can use for generating types
...
- Want to have ESLint support to enforce standards and maintain sanity across your team, try
  something like [GraphQL ESLint](https://github.com/B2o5T/graphql-eslint) and set it up with your
...
[**GraphQL Mesh**](https://graphql-mesh.com) or you can build it on your own since GraphQL just acts
as an abstraction on top.
...
Yes. [**GraphQL Tools**](https://graphql-tools.com) (which was initially from Apollo and then taken
...
[**Schema stitching**](https://graphql-tools.com/docs/stitch-combining-schemas) or
...
While we can have a separate blog on Schema Stitching versus Federation sometime down the line, each
have its own set of merits and demerits which you can understand only if you give both a try.
...
[**Type Merging**](https://graphql-tools.com/docs/stitch-type-merging)):
...
- Next, implement resolvers for every part of the schema in such a way that at phase 1, you just
  ...
  [**here**](https://the-guild.dev/blog/migrating-from-rest).
