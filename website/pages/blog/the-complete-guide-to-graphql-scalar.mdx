---
title: The Complete Guide to GraphQL Scalar
authors: eddeee888
...
![Visualisation of how input and output GraphQL Scalar work](/blog-assets/the-complete-guide-to-graphql-scalar/graphql-scalar-flow.jpg)
...
<Callout type="warning">
  ...
  In `typescript` and `typescript-resolvers` plugin v4.0.1, we have reverted the default ID Scalar input type to `string`. Read the [release notes](https://github.com/dotansimha/graphql-code-generator/releases/tag/release-1687159967878) for more details.
</Callout>
