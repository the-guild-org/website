...
const schema = createSchema({
  typeDefs: `...`,
  resolvers: [ // mergeResolvers are called internally
    authResolvers,
    bookResolvers,
    userResolvers,
  ]
...
<img alt="Search for resolver files easily because the filesystem location matches schema location" src="/blog-assets/scalable-apis-with-graphql-server-codegen-preset/filesystem-resolvers.png" />
