...
The serve command is now powered by [graphql-serve](https://npmjs.com/package/graphql-serve), letting you start up an in-memory GraphQL server and playground in seconds - perfect for mocking and testing!
