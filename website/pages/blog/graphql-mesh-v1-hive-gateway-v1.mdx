...
We, The Guild, are proud to announce both the Version 1 release of GraphQL Mesh and Hive Gateway,
and we believe this release brings a new perspective to GraphQL Federation that we call “Query
...
consumed by any Apollo Federation compatible gateway.
