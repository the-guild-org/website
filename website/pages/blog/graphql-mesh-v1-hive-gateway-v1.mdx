...
We, The Guild, are proud to announce both the Version 1 release of [GraphQL Mesh](/graphql/mesh) and
[Hive Gateway](/graphql/hive/docs/gateway), and we believe this release brings a new perspective to
[GraphQL Federation](/graphql/hive/federation) that we call “Query Anything, Run Anywhere”.
...
[GraphQL Yoga](/graphql/yoga-server) and [GraphQL Tools](/graphql/tools).

With Hive Gateway adding these features is now a simple configuration change, **no enterprise
license is required**!

- [GraphQL Subscriptions](/graphql/hive/docs/gateway/subscriptions) (via WebSocket, SSE, or HTTP
  Callbacks)
