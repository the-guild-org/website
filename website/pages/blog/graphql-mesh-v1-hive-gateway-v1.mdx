...
[GraphQL Mesh](https://the-guild.dev/graphql/mesh) and [Hive Gateway](https://the-guild.dev/graphql/hive/docs/gateway),
and we believe this release brings a new perspective to
[GraphQL Federation](https://the-guild.dev/graphql/hive/federation) that we call “Query Anything, Run Anywhere”.
