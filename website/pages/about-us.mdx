...
Each library is under a person's name, **not under [The Guild organization on GitHub](https://github.com/the-guild-org)**.
...
- Go through our [guide on how to contribute to our open source libraries](https://github.com/the-guild-org/Stack/blob/master/CONTRIBUTING.md)
