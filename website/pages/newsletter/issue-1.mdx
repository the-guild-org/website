...
[15 active projects](https://the-guild.dev/open-source) used by thousands of developers,
participating in the GraphQL Foundation projects, and working with many companies to help them get
the best of GraphQL.
...
[launch article](https://the-guild.dev/blog/announcing-graphql-yoga-v2),
...
This new open source project comes with its managed SaaS alternative, with a generous free “Hobby”
plan.

Get started by reading our launch article:
[https://the-guild.dev/blog/announcing-graphql-hive-public](https://the-guild.dev/blog/announcing-graphql-hive-public)
...
(`mergeFragmentTypes: true`) for all typescript plugins that enable merging “similar fragments”.
...
blog posts and services on our brand new [the-guild.dev](/) website ✨
