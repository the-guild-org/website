...
> [!NOTE]
>
> All 4 examples for v2 and v3 were updated on the latest Next.js 13.5.6 at the moment of
...
> [!WARNING]
>
>  The `.css` file is not included in the bundle report for Nextra 3, because the v3 blog
