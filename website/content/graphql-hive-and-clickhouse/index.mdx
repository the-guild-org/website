...
discussed the new data structure of ClickHouse](https://github.com/kamilkisiela/graphql-hive/issues/302). It shows the latency of the existing queries and how
we improved it.
