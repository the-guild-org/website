...
export const routeRules: Record<string, RouteRule> = {
  ...
  '/docs/access-tokens': redirect('/docs/schema-registry/management/access-tokens'),
  '/docs/features/alerts-notifications': redirect(
    '/docs/schema-registry/management/projects#alerts-and-notifications',
  ),
  '/docs/features/app-deployments': redirect('/docs/schema-registry/app-deployments'),
  '/docs/features/checking-schema': redirect('/docs/schema-registry#check-a-schema'),
  '/docs/features/delete-schema': redirect('/docs/schema-registry#delete-a-service'),
  '/docs/features/external-schema-composition': redirect(
    '/docs/schema-registry/external-schema-composition',
  ),
  '/docs/features/high-availability-cdn': redirect('/docs/schema-registry/high-availability-cdn'),
  ...
  '/docs/features/laboratory/**': redirect('/docs/schema-registry/laboratory'),
  '/docs/features/monitoring': redirect('/docs/schema-registry/usage-reporting'),
  '/docs/features/publish-schema': redirect('/docs/schema-registry#publish-a-schema'),
  '/docs/features/registry-usage': redirect('/docs/schema-registry/high-availability-cdn'),
  '/docs/features/schema-history': redirect('/docs/schema-registry#schema-history-and-changelog'),
  '/docs/features/schema-policy': redirect('/docs/schema-registry/schema-policy'),
  ...
  '/docs/features/tokens': redirect('/docs/schema-registry/management/targets#manage-tokens'),
  '/docs/features/usage-reporting': redirect('/docs/schema-registry/usage-reporting'),
  '/docs/management/sso-oidc-provider': redirect(
    '/docs/schema-registry/management/sso-oidc-provider',
  ),

  // Spec paths
  '/docs/specs/link-specifications': redirect('/docs/api-reference/link-specifications'),
  '/docs/specs/schema-reports': redirect('/docs/api-reference/cli#publish-a-schema'),
  '/docs/specs/usage-reports': redirect('/docs/api-reference/usage-reports'),

  // High-availability CDN (top level)
  '/docs/high-availability-cdn': redirect('/docs/schema-registry/high-availability-cdn'),
  ...
  // Gateway
  '/docs/gateway/deployment/node-frameworks': redirect('/docs/gateway/deployment/runtimes/nodejs'),
  ...
  '/docs/router/configuration/graphiql': redirect('/docs/router/configuration/laboratory'),
  '/docs/router/guides/extending-the-router': redirect('/docs/router/customizations'),
  '/docs/router/plugin-system': redirect('/docs/router/customizations/plugin-system'),
  ...
  '/docs/router/plugin-system/hooks': redirect('/docs/router/customizations/plugin-system/hooks'),
