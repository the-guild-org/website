...
## Example Usage in Hive Console

To evaluate the codegen support for the `@defer` directive, we integrated it into the Hive Console
application. Hive Console is a schema registry for GraphQL.
