...
```graphql title="user.query.graphql"
query user {
  userById {
...
```graphql title="userfields.fragment.graphql"
...
```graphql title="todo-list.query.graphql"
query todoList {
  todos {
    ...TodoItemFields
    ...TodoDetailsFields
...
```graphql title="me.query.graphql"
query me {
  me {
