...
<img
  alt="All queries are invalidated"
  src="https://dev-to-uploads.s3.amazonaws.com/i/f5s5de59uvkbjwbuwrou.png"
/>
...
<img
  alt="Live Query Store with schema coordinates on operation context"
  src="https://dev-to-uploads.s3.amazonaws.com/i/ft60prjse6pcqnlin4qv.png"
/>
...
<img
  alt="Live Query Store with resource identifiers and schema coordinates on operation context"
  src="https://dev-to-uploads.s3.amazonaws.com/i/cdicogp30k34ml9o3ccg.png"
/>

As mentioned above this allows more granular query invalidations.

<img
  alt="More granular updates are now possible"
  src="https://dev-to-uploads.s3.amazonaws.com/i/sde19ha6upubo0ofyg8a.png"
/>
