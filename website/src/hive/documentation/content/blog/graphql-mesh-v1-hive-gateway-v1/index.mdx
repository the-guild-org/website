...
>   registries such as Hive Console or Apollo Studio.
...
It is designed to fully integrate with with our Hive Console Platform offering, but also neatly
...
- [GraphQL API Usage and Analytics Reporting (Hive Console or Apollo Studio)](https://the-guild.dev/graphql/hive/docs/gateway/usage-reporting)
