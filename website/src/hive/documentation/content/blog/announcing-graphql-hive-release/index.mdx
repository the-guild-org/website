---
title: Announcing Hive Console, the complete GraphQL API manager
tags: [graphql, graphql-federation, graphql-hive]
authors: [charlypoly, arda, laurin, saihaj, kamil, dotan, uri, dimitri]
date: 2022-05-24
description: We are incredibly excited to share with you today the public launch of Hive Console!
---
...
[Hive Console](https://the-guild.dev/graphql/hive) has been built with 3 main objectives in mind:
...
- **Open Source at the heart**: Hive Console is 100% open-source, and build in public with the
  community.
- **A plug and play SaaS solution**: to give access to Hive to most people with a generous free
  “Hobby plan”

Without further ado, let's review together how Hive Console will help you to get the best of your
GraphQL APIs.

## Features Overview

Hive Console provides all the tools to get visibility of your GraphQL architecture at all stages,
...
Hive Console helps you get a global overview of the usage of your GraphQL API with:
...
## Get Started with Hive Console

By far the easiest way to use Hive Console is to get started with one of our hosted plans below.
...
### Hive Console Can Be Self-Hosted

As stated earlier, [Hive Console](https://the-guild.dev/graphql/hive) is completely open-source
