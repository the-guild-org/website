...
![New web app integration](./okta-new-web-app-integration.png)
...
![Application general settings](./okta-application-general-settings.png)

Last, switch over to the `Okta API Scopes` tab and grant access to the `okta.users.read.self` scope.

![Application general settings](./okta-okta-api-scopes.png)
