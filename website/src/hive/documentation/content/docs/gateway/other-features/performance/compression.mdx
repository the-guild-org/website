...
<GraphFlow title="Directions">

- Client → Gateway → Subgraphs
- Subgraphs → Gateway → Client
...
<GraphFlow title="Gateway to client">

- Client → _adds `Accept-Encoding`_ → Gateway → **compresses** → _adds `Content-Encoding`_ → Client →
  decompresses
...
<GraphFlow title="Client to gateway">

- Client → **compresses** → _adds `Content-Encoding`_ → Gateway → decompresses
...
<GraphFlow title="Subgraph to gateway">

- Gateway → _adds `Accept-Encoding`_ → Subgraph → **compresses** → _adds `Content-Encoding`_ →
  Gateway → decompresses
...
<GraphFlow title="Gateway to subgraph">

- Gateway → **compresses** → Subgraph → decompresses
