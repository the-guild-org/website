...
export const gatewayConfig = defineConfig({
  supergraph: {
    ...
    remote: true,
    /** GraphQL API endpoint of the registry. */
...
| ---------- | ------------------------------ | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `remote`   | `--dev-remote`                 | `DEV_REMOTE`         | Compose through the Hive registry instead of locally. Requires `registry` and `token`.                                                  |
| `registry` | `--dev-registry <endpoint>`    | `DEV_REGISTRY`       | The registry's GraphQL API endpoint. For Hive Cloud this is `https://app.graphql-hive.com/graphql`.                                     |
