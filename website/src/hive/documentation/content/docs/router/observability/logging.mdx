...
| `supergraph_name`       | Name of the supergraph that served the request: `default` for the configured supergraph, or the name a [plugin](/docs/router/supergraph#from-a-custom-plugin) gave its variant. Omitted when the request was rejected before a supergraph was selected. |
...
```
2026-07-15T21:23:27.123456Z  INFO router::request: operation_name="GetProduct" operation_type="query" subgraph_requests=2 involved_subgraphs="products,reviews" error_count=0 status_code=200 supergraph_name="default" duration_ms=14 request_id=01J8... trace_id=4bf92f3577b34da6a3ce929d0e0e4736
```
