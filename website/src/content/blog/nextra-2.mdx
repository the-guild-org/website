...
> On the original interactive version of this post, Nextra's README was rendered here live from
> GitHub. [Read the README on GitHub](https://github.com/shuding/nextra#readme) instead.
...
![Example of Nextra page](/blog-assets/nextra-2/page.png)
...
<Video src="/blog-assets/nextra-2/flexsearch.mp4" />
...
![Example of Nextra page with RTL direction](/blog-assets/nextra-2/rtl.png)
...
![Example of Nextra page with contrast mode enabled](/blog-assets/nextra-2/contrast-mode.png)
