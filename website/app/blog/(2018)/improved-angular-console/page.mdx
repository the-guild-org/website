...
> [Angular Console](http://angularconsole.com) is a user interface for Angular CLI created by
...
really interesting in [the next PR](https://github.com/nrwl/nx-console/pull/175).
...
It wouldn't be possible without introducing this new API. I highly recommend to read
[an article](/blog/apollo-angular-12), it explains what it is and how it could be used with the
codegen.
...
Here is [the relevant PR](https://github.com/nrwl/nx-console/pull/219) introducing this change into
Angular Console.
