...
instead of using the replication version in npm which has the same name. You can see more on
[the related post about MCB](/blog/whats-new-on-meteor-client-bundler).
