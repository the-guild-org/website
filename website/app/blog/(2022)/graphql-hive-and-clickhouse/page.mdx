...
![An overview of the architecture](/blog-assets/graphql-hive-and-clickhouse/data-pipeline.png)
...
![Data collecting part](/blog-assets/graphql-hive-and-clickhouse/data-collecting-part.png)
...
![Data processing part](/blog-assets/graphql-hive-and-clickhouse/data-processing-part.png)
...
![An overview of our ClickHouse tables](/blog-assets/graphql-hive-and-clickhouse/tables.png)
...
![Operations page and the date range filter](/blog-assets/graphql-hive-and-clickhouse/date-ranges.png)
...
and learn from our mistakes. Here's an excellent example of what we mean, it's
[an issue where we discussed the new data structure of ClickHouse](https://github.com/kamilkisiela/graphql-hive/issues/302).
...
![Operations page and the Clients section](/blog-assets/graphql-hive-and-clickhouse/clients.png)
...
![Difference between synchronous and asynchronous inserts in ClickHouse](/blog-assets/graphql-hive-and-clickhouse/async-sync-inserts.png)
