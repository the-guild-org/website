...
import nextraContrastMode from './contrast-mode.png'
import nextraPage from './page.png'
import nextraRtl from './rtl.png'
...
`<NextImage>` will prevent to have layout shifts on your page. Instantiate (client-side) navigation
would be done with `<NextLink>`.
...
> [!TIP]
>
> You can manually pass Next SEO props with `useNextSeoProps` theme option.
> [Read more](https://nextra.site/docs/docs-theme/theme-configuration#seo-options) in the docs.
