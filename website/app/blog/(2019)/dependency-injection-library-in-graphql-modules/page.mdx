...
If you want to know more about **_encapsulation_** see
[the blog post](/blog/modular-encapsulation-graphql-modules) about it.
...
You can read more about the different scopes that we have in GraphQL-Modules
[here](/blog/graphql-modules-scoped-providers).
