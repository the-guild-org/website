...
export const meta = {
  ...
  date: "2019-8-8",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*scQ-ST9kcviAtUPjq1BYEw.gif",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*scQ-ST9kcviAtUPjq1BYEw.gif?raw=true)
...
[We’ve](http://the-guild.dev) recently [taken over the maintenance](https://medium.com/the-guild/the-guild-is-taking-over-maintenance-of-merge-graphql-schemas-so-lets-talk-about-graphql-schema-46246557a225) of [GraphQL-Scalars](https://github.com/urigo/graphql-scalars) library from the amazing team of OK-Grow!
