...
export const meta = {
  title: "<💅> Introducing a new encapsulation method for Styled-Components with Babel",
  tags: [],
  date: "2019-3-4",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*mlEERn6nS_ulsxBbXjfMng.png",
};
