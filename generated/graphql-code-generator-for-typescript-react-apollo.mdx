...
export const meta = {
  ...
  date: "2018-8-21",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*e9-8DMsw80IYIaK1cf3odg.png",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*e9-8DMsw80IYIaK1cf3odg.png?raw=true "GraphQL Code Generator — React Apollo Typescript template")
...
> Follow us on **_GitHub_** and **_Medium_**, we are planning to release many more posts in the next couple of weeks about what we’ve learned using **_GraphQL_** in recent years.
>
