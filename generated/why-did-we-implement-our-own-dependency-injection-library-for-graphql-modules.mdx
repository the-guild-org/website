...
That’s why, we implemented our own platform-agnostic Dependency Injection library called `_@graphql-modules/di_` which is independent from `_@graphql-modules/core_`, and it can be used by itself.
...
> Follow us on [**GitHub**](https://github.com/Urigo/graphql-modules) and [**Medium**](https://medium.com/the-guild), we are planning to release many more posts in the next couple of weeks about what we’ve learned using **GraphQL** in recent years.
>
