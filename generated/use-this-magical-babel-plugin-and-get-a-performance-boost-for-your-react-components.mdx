...
export const meta = {
  ...
  description: 'TODO:',
  image:
    'https://github.com/the-guild-org/oneblog/blob/master/img/704/1*ytNEFZJa5z-5mWrwitD4yQ.jpeg',
};

export default withArticle({ ...meta });

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*ytNEFZJa5z-5mWrwitD4yQ.jpeg?raw=true)
...
export default ({ data, sortComparator, filterPredicate, history }) => {
  ...
  return React.createElement(
    (_anonymousFnComponent2 =
      _anonymousFnComponent2 ||
      (() => {
        const _onClick2 = React.useCallback(() => history.pop(), [
          history,
          history.pop,
        ]);
