...
export const meta = {
  ...
  date: "2018-12-4",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*dt-D8lmQyIGZ-e5993wn0Q.png",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*dt-D8lmQyIGZ-e5993wn0Q.png?raw=true "GraphQL Code Generator will boost your DX")
