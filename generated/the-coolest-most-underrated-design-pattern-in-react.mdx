...
export const meta = {
  ...
  date: "2019-7-31",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*CJ1h6vCuTM2RAW25RKw-Sw.png",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*CJ1h6vCuTM2RAW25RKw-Sw.png?raw=true)
