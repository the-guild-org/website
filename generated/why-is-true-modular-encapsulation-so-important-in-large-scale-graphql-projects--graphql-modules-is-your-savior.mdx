...
export const meta = {
  title: "Why is True Modular Encapsulation So Important in Large-Scale GraphQL Projects? — GraphQL Modules is your savior!",
  tags: [],
  date: "2019-1-7",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*F9zPdgtNF9oL3IG0eL4NTg.png",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*F9zPdgtNF9oL3IG0eL4NTg.png?raw=true "Encapsulation matters in large-scale projects")
