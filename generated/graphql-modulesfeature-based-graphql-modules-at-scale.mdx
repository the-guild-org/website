...
export const meta = {
  ...
  date: "2018-11-5",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*44e5SD72vLOc9h_Nz_Aqhg.png",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*44e5SD72vLOc9h_Nz_Aqhg.png?raw=true "https://graphql-modules.com/")
