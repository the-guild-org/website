...
export const meta = {
  ...
  date: "2019-6-24",
  description: "TODO:",
  image: "https://github.com/the-guild-org/oneblog/blob/master/img/704/1*Ld9bh_dmakdkMOP3ByZc7Q.jpeg",
};
      
export default withPost({ ...meta });
  

![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*Ld9bh_dmakdkMOP3ByZc7Q.jpeg?raw=true)
