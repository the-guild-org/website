...
export const meta = {
  title: "Apollo-Angular 1.2 — using GraphQL in your apps just got a whole lot easier!",
  tags: [],
  date: "2018-8-21",
  description: "TODO:",
  image: "",
...
_Check what’s new in Apollo Angular and how to get the full potential benefits of using Angular + GraphQL + TypeScript combined thanks to GraphQL-Code-Generator._


![](https://github.com/the-guild-org/oneblog/blob/master/img/704/1*uNJMkGOWodBQKubVRVCP0A.png?raw=true "GraphQL Code Generator — Angular Apollo Template")
...
Next, you run the [**GraphQL Code Generator — Angular Apollo Plugin**](https://graphql-code-generator.com/docs/plugins/typescript-apollo-angular)  to generate types and angular services.
...
Auto generated apollo-angular services. Posts and Authors - new Apollo Angular GraphiQL…stackblitz.com")
...
-   **Apollo Angular Boost** It’s hard for newcomers to get started with Apollo Angular. Inspired by Apollo Boost we decided to create an Angular version of it. Here’s [an interactive example](https://stackblitz.com/edit/simple-apollo-angular-boost-example).

-   **Create Apollo on DI level** There is now an extra way to create Apollo Client. Instead of using `Apollo.create` inside of a constructor, you can provide settings on Dependency Injection level. Read the [“Using Dependency Injection”](https://www.apollographql.com/docs/angular/basics/setup.html#using-dependency-injection) chapter in docs.
...
-   **Automatic Persisted Queries for Angular** It’s now possible to use APQ with Angular’s HttpClient, just install [this package](http://apollo-angular-link-persisted).
...
-   Query and Mutation — [Step by step tutorial](https://github.com/kamilkisiela/apollo-angular-introduction)
