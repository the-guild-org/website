...
date: 2019-01-07
description: Why is True Modular Encapsulation So Important in Large-Scale GraphQL Projects? — GraphQL Modules is your savior!
...
![](../../public/medium/c806f0ae70dca7a4d1e434736f241ed5.png 'Every module has its own schema, context and DI container. Here you can see AuthModule is appended to UserModule. But, other modules don't import AuthModule. So, they cannot access directly AuthModule DI container or context.')
