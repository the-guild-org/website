...
date: 2020-05-01
description: Intercept schema changes via HTTP and decide which changes are acceptable which are not and all of this through a serverless function.
...
We recently released a lot more interesting features. You can read about them in ["New GraphQL Inspector and upcoming features"](https://the-guild.dev/blog/new-graphql-inspector) article.
...
Every Push or opened Pull Request is checked with GraphQL Inspector and based on the changes in a schema, it decides whether to reject those changes. We don't want to stop you there so Inspector lets you to review changes and decide what to do.
